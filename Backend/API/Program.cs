...
builder.Services.AddScoped<IStudentRelationRepository, StudentRelationRepository>();
builder.Services.AddScoped<IStudentRelationService, StudentRelationService>();
